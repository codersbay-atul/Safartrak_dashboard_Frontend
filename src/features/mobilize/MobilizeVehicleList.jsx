...
export default function MobilizeVehicleList({
  ...
  return (
    <div className="w-full h-full bg-[#141416] border border-[#222226] rounded-2xl p-4 flex flex-col select-none overflow-hidden shadow-2xl">
      {/* Title */}
      ...
      <div className="flex items-center gap-2 pb-2 mb-3 shrink-0 overflow-x-auto no-scrollbar">
      ...
      <div className="flex flex-col gap-2.5 overflow-y-auto pr-1 flex-1 custom-scrollbar">
        {vehicles.length > 0 ? (
          vehicles.map((vehicle) => {
            ...
            return (
              <div
                ...
                className={`flex items-center justify-between py-3 px-4 rounded-xl border transition-all duration-150 w-full gap-4 shrink-0 cursor-pointer ${
                  isSelected
              ...
              >
                ...
                <div className="min-w-0 flex-1 grid grid-cols-1 sm:grid-cols-2 gap-3 items-center">
                ...
                <div className="flex items-center gap-3 shrink-0">
                  <button
                    ...
                    className={`h-8 px-4 rounded-full text-xs font-medium transition-all flex items-center justify-center cursor-pointer ${
                      action.className
                    }`}
                  >
                    {action.label}
          ...
          <div className="flex flex-1 items-center justify-center rounded-xl border border-dashed border-[#27272a] bg-[#141416] p-8 text-center">
            <p className="text-xs text-[#71717a]">No vehicles found</p>
          </div>
        )}
      </div>
    </div>
